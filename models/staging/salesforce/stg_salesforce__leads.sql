with
    ...
    snake_case_field_names_and_clean_timestamps as (ord
        ...
        select
            ...
            cast(
                "OTHER_AGENT_TENANCY_START_MONTH_C" as date
            ) as other_agent_tenancy_start_month,
            ...
            "PROPERTY_SIGNUP_REQUEST_OUTSTANDING_C"
            as property_signup_request_outstanding,
            ...
            "NON_DISCOUNTED_ENERGY_WEEKLY_COST_PP_C"
            as non_discounted_energy_weekly_cost_pp,
            "NON_DISCOUNTED_BROADBAND_WEEKLY_COST_PP_C"
            as non_discounted_broadband_weekly_cost_pp,
            "NON_DISCOUNTED_WATER_WEEKLY_COST_PP_C"
            as non_discounted_water_weekly_cost_pp,
            "NON_DISCOUNTED_TV_LICENCE_WEEKLY_COST_PP_C"
            as non_discounted_tv_licence_weekly_cost_pp,
            ...
            "CAMPAIGN_MONITOR_EXCLUDED_LETTING_AGENTS_C"
            as campaign_monitor_excluded_letting_agents,
            ...
            "COUNT_OF_CLOSED_TASKS_ON_CONVERSION_C"
            as count_of_closed_tasks_on_conversion,
            "COUNT_OF_EMAILS_SENT_ON_CONVERSION_C"
            as count_of_emails_sent_on_conversion,
            ...
            "REASON_FOR_NOT_SIGNING_BILLS_INCLUSIVE_C"
            as reason_for_not_signing_bills_inclusive,
