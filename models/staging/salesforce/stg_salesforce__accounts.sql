with
    ...
    snake_case_field_names_and_clean_timestamps as (
        ...
        -- Original command was:  select {{ select_fields_structured('salesforce', 'account') }} from {{ source('salesforce', 'account') }}
        select
            "ID" as account_id,
            ...
            cast(
                "MID_CONTRACT_INTERNET_UPGRADE_ORDER_DATE_C" as date
            ) as mid_contract_internet_upgrade_order_date,
            cast("CONTRACT_END_DATE_C" as date) as contract_end_date,
            cast(
                "VIRGIN_SERVICEABILITY_SENT_DATE_C" as date
            ) as virgin_serviceability_sent_date,
            cast("AGREEMENT_SENT_DATE_1_C" as date) as agreement_sent_date_1,
            cast(
                "TENANCIES_DISCLAIMER_ACCEPTED_DATE_TIME_C" as timestamp
            ) as tenancies_disclaimer_accepted_date_time,
            ...
            cast(
                "REQUESTED_INSTALLATION_DATE_C" as date
            ) as requested_installation_date,
            ...
            cast(
                "DIRECT_DEBIT_CANCELLED_DATE_C" as date
            ) as direct_debit_cancelled_date,
            cast(
                "X_1_ST_INSTALL_DATE_REQUEST_C" as date
            ) as x_1_st_install_date_request,
            cast("TV_LICENCE_START_DATE_C" as date) as tv_licence_start_date,
            cast(
                "X_2_ND_INSTALL_DATE_REQUEST_C" as date
            ) as x_2_nd_install_date_request,
            ...
            cast(
                "PREPAYMENT_METER_EXCHANGE_DATE_C" as date
            ) as prepayment_meter_exchange_date,
            cast(
                "PROOF_OF_UTILITY_PAYMENTS_DATE_C" as date
            ) as proof_of_utility_payments_date,
            ...
            cast(
                "ESTIMATED_ROUTER_DELIVER_DATE_C" as date
            ) as estimated_router_deliver_date,
            ...
            cast(
                "LAST_VERBAL_ACTIVITY_BY_ACCOUNT_OWNER_C" as timestamp
            ) as last_verbal_activity_by_account_owner,
            cast(
                "LAST_WRITTEN_ACTIVITY_BY_ACCOUNT_OWNER_C" as timestamp
            ) as last_written_activity_by_account_owner,
            ...
            cast(
                "EXTENSION_DATE_PRICE_INCREASE_C" as date
            ) as extension_date_price_increase,
            ...
            cast(
                "DATE_INTERNET_UPGRADE_EMAIL_SENT_C" as timestamp
            ) as date_internet_upgrade_email_sent,
            cast(
                "DATE_TIME_INTERNET_PACKAGE_SELECTED_C" as timestamp
            ) as date_time_internet_package_selected,
            cast(
                "FIBRE_SERVICEABILITY_SENT_DATE_C" as date
            ) as fibre_serviceability_sent_date,
            ...
            cast(
                "ELECTRICITY_ACCOUNT_CLOSED_DATE_C" as date
            ) as electricity_account_closed_date,
            cast("_FIVETRAN_SYNCED" as timestamp) as fivetran_synced,
            cast(
                "LAST_SUCCESSFUL_VERBAL_ACTIVITY_C" as timestamp
            ) as last_successful_verbal_activity,
            ...
            "ESTIMATED_ANNUAL_ELECTRICITY_USAGE_C"
            as estimated_annual_electricity_usage,
            ...
            "STATUS_C" as status,
            "ACCOUNT_NUMBER_C" as account_number_1,
            ...
            "SUPPLY_DATA_COPIED_FROM_PREVIOUS_YEAR_C"
            as supply_data_copied_from_previous_year,
            ...
            "INITIAL_ELECTRICITY_READING_2_K_WH_C"
            as initial_electricity_reading_2_k_wh,
            ...
            "TRIGGER_SUPPLIED_LAST_YEAR_MANUALLY_C"
            as trigger_supplied_last_year_manually,
            ...
            "PROPOSED_EL_SUPPLIER_ACCOUNT_NUMBER_C"
            as proposed_el_supplier_account_number,
            ...
            "PROPOSED_GAS_SUPPLIER_ACCOUNT_NUMBER_C"
            as proposed_gas_supplier_account_number,
            ...
            "NEW_AB_AGREEMENT_STATUS_PRICE_INCREASE_C"
            as new_ab_agreement_status_price_increase,
            "COMMISSION_C" as commission,
            "NEW_FORMS_SENT_PRICE_INCREASE_C" as new_forms_sent_price_increase,
            "NEW_MARKETING_MATERIALS_SENT_PRICE_INCR_C"
            as new_marketing_materials_sent_price_incr,
            ...
            "EXCLUDE_FROM_COMMISSION_AUTOMATION_C"
            as exclude_from_commission_automation,
            "NUMBER_C" as number,
            ...
            "WHICH_UTILITIES_ARE_ALREADY_INCLUDED_C"
            as which_utilities_are_already_included,
            ...
            "INCUMBENT_ELECTRICITY_ACCOUNT_NUMBER_C"
            as incumbent_electricity_account_number,
            ...
            "EXCLUDE_FROM_INSTALLATION_AUTOMATION_C"
            as exclude_from_installation_automation,
            ...
            "VIRGIN_REPLACEMENT_ROUTER_TEMPORARY_FLAG_C"
            as virgin_replacement_router_temporary_flag,
