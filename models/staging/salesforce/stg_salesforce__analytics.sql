with
    ...
    source as (select * from {{ source("salesforce", "analytics") }}),
    ...
    snake_case_field_names_and_clean_timestamps as (
        ...
        -- Original command was:   select {% raw %}{{ select_fields_structured('salesforce', 'analytics') }}{% endraw %} from excluding_deleted_records
        select
            "ID" as analytics_id,
            ...
            "TOTAL_ORDER_FORM_WITH_CANCELLATION_C" as total_order_form_with_cancellation,
            ...
            "LETTING_SEASON_SPEND_ON_FEATURED_PROPERT_C" as letting_season_spend_on_featured_propert,
